...
public class InputScript : MonoBehaviour {
	...
	void FixedUpdate () {
		if (inputEnabled) {
			...
			// double button input b and y
			if (((prevState.Buttons.Y == ButtonState.Released && state.Buttons.Y == ButtonState.Pressed) && state.Buttons.B == ButtonState.Pressed)
			   || ((prevState.Buttons.B == ButtonState.Released && state.Buttons.B == ButtonState.Pressed) && state.Buttons.Y == ButtonState.Pressed)
			   || ((prevState.Buttons.B == ButtonState.Released && state.Buttons.B == ButtonState.Pressed) && (prevState.Buttons.Y == ButtonState.Released && state.Buttons.Y == ButtonState.Pressed))) {
				Debug.Log ("super input");
				StopAllCoroutines ();
	...
	public void assignBYButton(buttonDelegate byPress){
		byButtonPress = byPress;
	}
